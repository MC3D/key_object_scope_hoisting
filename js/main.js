...
console.log(foo()) will print "function hoisting"
...
inside the IFEE, console.log(add) will print 4
outside the IFEE, console.log(add) will print a reference error; add is not defined;
add is a local variable; accessible only inside the function in which it is declared
...
(function() {
  ...
  pizza.pizzaMkr(); // moved function below variable declaration
...
(function() {
  "use strict";
  var goodStanding = true; // modified values ///////////////////////////////////////////////////////
  var monthsActive = 18; // modified values /////////////////////////////////////////////////////////
  //Do not modify 'name' globaly.
  var name = null;
  var benefit = {}
  // Added properties to 'benefit' using braket notation ////////////////////////////////////////////
  benefit['credit'] = 50;
  benefit['discount'] = 5;
  ///////////////////////////////////////////////////////////////////////////////////////////////////
  var accountCheck = function() {
    name = 'James'; // modified the value of name ///////////////////////////////////////////////////
  ...
  accountCheck(); // moved this below the function expression ////////////////////////////////////////
...
(function() {
  ...
  function duplicate() {
    var multiply = 2 * 10; // create a local variable that will not override the value of the global variable
    return; // added a return statement; always return from a function; /////////////////
  };

  duplicate();

  // console.log("multiply", multiply);
  console.assert(multiply === 16, "Test failed. How can we isolate duplicate()");
})();
